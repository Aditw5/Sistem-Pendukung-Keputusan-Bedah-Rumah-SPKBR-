...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Data Kriteria</h2><hr/>
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('kriteria'); ?>" class="btn btn-danger">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<!-- <th>Action</th> -->
			...
			<td><?php echo $kriteria->jenis_kriteria ?></td>
			<!-- <td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('kriteria/read/'.$kriteria->id_kriteria),'Read'); 
				echo ' | '; 
